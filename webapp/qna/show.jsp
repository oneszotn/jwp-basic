				...
				<article class="article">
					...
					<div class="article-util">
						<ul class="article-util-list">
							...
							<li>
								<form class="form-delete" action="/qna/deleteQna" method="POST">
									<input type="hidden" name="_method" value="DELETE">
									<input type="hidden" name="questionId" value="${question.questionId}">
									<button class="link-delete-article" type="submit">삭제</button>
								</form>
								<form class="form-delete" action="/api/qna/deleteQna" method="POST">
									<input type="hidden" name="_method" value="DELETE">
									<input type="hidden" name="questionId" value="${question.questionId}">
									<button class="link-delete-article" type="submit">모바일용 삭제</button>
								</form>
							</li>
							<li>
							...
							<article class="article">
									...
									<div class="article-util">
										<ul class="article-util-list">
											...
											<li>
												<form name="deleteCommnet" class="form-delete" action="/api/qna/deleteAnswer" method="POST">
