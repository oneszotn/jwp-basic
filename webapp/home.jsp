...
<div class="container" id="main">
	<div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
		<div class="panel panel-default qna-list">
			<ul class="list">
			<c:forEach items="${qus}" var="qu" varStatus="status">
				<li>
					<div class="wrap">
						<div class="main">
		                	<strong class="subject">
								<a href="/qna/show?questionId=${qu.questionId}">${qu.title}</a>
							</strong>
							<div class="auth-info">
								<i class="icon-add-comment"></i>
								<span class="time">${qu.createdDate}</span>
								<a href="./user/profile.html" class="author">${qu.writer}</a>
							</div>
							<div class="reply" title="댓글">
								<i class="icon-reply"></i>
								<span class="point">${qu.countOfAnswer}</span>
							</div>
						</div>
					</div>
				</li>
